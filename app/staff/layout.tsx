...
import { LayoutDashboard, Package, ShoppingCart, Users, LogOut, Menu, X, Bell, Search } from "lucide-react"
...
export default function StaffLayout({
  ...
  const handleLogin = () => {
    localStorage.setItem("staffAuth", "authenticated")
    setIsAuthenticated(true)
  }
          ...
          <div className="bg-card border border-border rounded-lg p-8 shadow-lg">
            <div className="text-center space-y-6">
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground">Access the staff dashboard</p>
              </div>
              ...
              <div className="text-sm text-muted-foreground">Demo: Click "Sign In" to access staff dashboard</div>
            </div>
          </div>
        </motion.div>
      </div>
  ...
  return (
    <Suspense fallback={<div>Loading...</div>}>
      <div className="min-h-screen bg-background flex">
        ...
        {/* Sidebar */}
      <aside
  className={`fixed left-0 top-0 z-50 h-full w-64 bg-card border-r border-border transform transition-transform duration-200
          ...
          <div className="flex h-full flex-col">
            ...
            <div className="flex h-16 items-center justify-between px-6 border-b border-border">
              <Link href="/staff" className="flex items-center space-x-2">
                ...
                <span className="font-bold text-foreground">Staff</span>
              </Link>
            ...
            <div className="flex items-center gap-2">
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                  <DropdownMenuLabel>Staff User</DropdownMenuLabel>
                  <DropdownMenuSeparator />
