...
export default function KidsPage() {
  ...
  const subcategories = ["athletic", "casual", "school"]
    ...
    <div className="min-h-screen bg-background">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="space-y-4">
                ...
                <p className="text-lg text-muted-foreground leading-relaxed text-pretty">
                  Durable, comfortable, and fun shoes designed for active kids. From playground adventures to classroom
                  comfort.
                </p>
              </div>
            ...
            >
              <div className="relative aspect-square rounded-2xl overflow-hidden">
                <Image
                  src="/placeholder.svg?height=500&width=500&text=Kids+Shoes"
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-3xl font-bold text-foreground">Shop by Activity</h2>
            <p className="text-lg text-muted-foreground">Perfect shoes for every adventure</p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {subcategories.map((subcategory, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <Link href={`/kids/${subcategory}`} className="group block">
      ...
      <section className="py-16 bg-muted/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            className="text-center space-y-4 mb-12"
          >
            <h2 className="text-3xl font-bold text-foreground">Featured Kids' Shoes</h2>
            <p className="text-lg text-muted-foreground">Top picks for growing feet</p>
          </motion.div>
